...
namespace Partial_Ex4
{
    public class Point3D
    {
        ...
        {
            //coordonatele punctelor din centrul ecranului
            ...
            form.graphics.FillEllipse(new SolidBrush(Color.White), projectionX - size/2, projectionY - size/2, size, size);
            //form.BackgroundImage = form.bitmap;
        }
    }
}
